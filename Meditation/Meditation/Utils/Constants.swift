...
struct ProgramConstants {
    static func getPrograms() -> [Program] {
        let program1 = Program(title: "Meditation 101", description: "Techniques, Benefits, and a Beginner’s How-To", photoUrl: UIImage(named: "imgMeditation101"), videoUrl: "https://www.youtube.com/watch?v=85ZM6XPYQpA")
        let program2 = Program(title: "Cardio Meditation", description: "Basics of Yoga for Beginners or Experienced Professionals", photoUrl: UIImage(named: "imgCardioMeditation"), videoUrl: "https://www.youtube.com/watch?v=M75-qW80_6U")
        let program3 = Program(title: "Loving-Kindness Meditation", description: "Loving-kindness meditation is used to strengthen feelings of compassion, kindness, and acceptance toward oneself and others.", photoUrl: UIImage(named: "imgLovingKidnessMeditation"), videoUrl: "https://www.youtube.com/watch?v=aVJdxv9thkA&t=286s")
        let program4 = Program(title: "Transcendental Meditation", description: "This practice is for those who like structure and are serious about maintaining a meditation practice.", photoUrl: UIImage(named: "imgTranscendental"), videoUrl: "https://www.youtube.com/watch?v=ZuoMXHhyMMs")
        let program5 = Program(title: "Mantra meditation", description: "This type of meditation uses a repetitive sound to clear the mind.", photoUrl: UIImage(named: "imgMantraMeditation"), videoUrl: "https://www.youtube.com/watch?v=vbVh43mTHF4")
